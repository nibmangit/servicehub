...
/**
 * Field names mirror the Django API. UI-only display helpers are `_`-prefixed.
 */
...
export const requests = [
  ...
  },
  {
    ...
    start_otp: null, complete_otp: null,
    rejection_reason: null, completed_at: null,
    created_at: "2025-05-24T10:00:00Z", updated_at: "2026-05-25T09:00:00Z",
...
export const customerDashboard = {
  ...
  recent_requests: requests.slice(0, 4).map((r) => ({
    id: r.id, service__title: r._service ? r._service.title : "Service",
    provider__user__email: r._service && r._service._providerName ? `${r._service._providerName.split(" ")[0].toLowerCase()}@example.com` : "provider@example.com",
